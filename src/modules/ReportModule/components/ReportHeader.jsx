...
export default function ReportHeader({ config, filterTable }) {
    // let { searchConfig } = config;
    let searchConfig = '';
    const translate = useLanguage();
    const [options, setOptions] = useState({ q: '', fields: searchConfig.searchFields, startDay: '', endDay: '', sort: -1, client: '', project: '', userId: '' });
            ...
            <PageHeader
                ...
                extra={[
                    <div className='grid justify-between' style={{ gridTemplateColumns: "auto auto" }} key={1} >
                        <div className='grid gap-x-5 justify-start ' style={{ gridTemplateColumns: "auto auto auto auto auto auto minmax(auto, 640px)" }}>
